...
<h4 align="center">لیست تمام تیکت ها فعال و باز</h4>
<div id="mainpg">
<table border="1" cellpadding="4" cellspacing="0"  >
<td style="font:Tahoma ;color:#FF0000" > <b>  ورود  </b> </td>
<td style="font:Tahoma ;color:#FF0000" > <b>  بستن تیکت  </b> </td>
...
<td style="font:Tahoma ;color:#FF0000" > <b>  کد پیگیری ارسال کننده  </b> </td>
...
$query="Select * from tikects where  sust='1' OR  sust='2' OR sust='3' OR  sust='4' ORDER BY id DESC " ;
...
{echo "<a href=\"./ViewTikect.php?NUMber=$row[0]&Username=$row[2]\"><img src='../img/enter2.png' class='mg' width='35' height='35' /> </a>";}
...
echo "<td align='center'>";
echo  '<a href="./mng_tikets.php?del='.$row[0].'&Username='.$row[2].'" onclick="';
echo 'return confirm';
echo "('آیا می خواهید این تیکت بسته شود ؟";
echo "')";
echo '"';
...
echo "<td align='center' >";
if($row[5]==1 || $row[5]==2)
{echo '<font color="#FF0000"  size="+1" >پاسخ کاربر</font><br/>';}
else if($row[5] ==3 || $row[5] ==4)
{echo '<font color="#009933"  size="+1" >پاسخ مدیریت</font><br/>';}
else if($row[5] ==5)
...
echo "<td align='center'> <b> ".DeCryption($row[2])." </b> </td>";
...
if(isset($_REQUEST['del']) &&  isset($_REQUEST['Username'])){

$Use=str_replace(" ","+",$_REQUEST['Username']);
$id_F=$_REQUEST['del'];
$sql="UPDATE  tikects SET sust='5' where tblname='".$_SESSION['sqlslt']."' AND username='".$Use."' AND id='".$id_F."' " ;
...
echo '<script> alert ("تیکت مورد نظر با موفقیت بسته شد");</script>';			
echo  "<meta http-equiv=\"refresh\" content=\"0;URL=./mng_tikets.php\">";
...
if($num==0){echo '<font color="#FF0000"  size="+1" >تیکت  فعال وباز ای وجود ندارد</font><br/>';}
